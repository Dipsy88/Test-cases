...
# Check if you can create an alert for 10 seconds
...
class TestCase_7:
    ...
    def internet_on(self):
        ...
        try:
            ...
            remote_conn2.send('xcommand Message Alert Display Title: "Message" Text: "This alert will end in 10 seconds." Duration: 10 \n')
            time.sleep(10)
